...
**
*/
#define CFE_PLATFORM_SB_MAX_MSG_IDS         CFE_PLATFORM_SB_CFGVAL(MAX_MSG_IDS)
#define DEFAULT_CFE_PLATFORM_SB_MAX_MSG_IDS 256
...
**
*/
#define CFE_PLATFORM_SB_MAX_PIPES         CFE_PLATFORM_SB_CFGVAL(MAX_PIPES)
#define DEFAULT_CFE_PLATFORM_SB_MAX_PIPES 64
...
**
*/
#define CFE_PLATFORM_SB_MAX_DEST_PER_PKT         CFE_PLATFORM_SB_CFGVAL(MAX_DEST_PER_PKT)
#define DEFAULT_CFE_PLATFORM_SB_MAX_DEST_PER_PKT 16
...
**
*/
#define CFE_PLATFORM_SB_DEFAULT_MSG_LIMIT         CFE_PLATFORM_SB_CFGVAL(DEFAULT_MSG_LIMIT)
#define DEFAULT_CFE_PLATFORM_SB_DEFAULT_MSG_LIMIT 4
...
**
*/
#define CFE_PLATFORM_SB_BUF_MEMORY_BYTES         CFE_PLATFORM_SB_CFGVAL(BUF_MEMORY_BYTES)
#define DEFAULT_CFE_PLATFORM_SB_BUF_MEMORY_BYTES 65536
...
*/
#define CFE_PLATFORM_SB_HIGHEST_VALID_MSGID         CFE_PLATFORM_SB_CFGVAL(HIGHEST_VALID_MSGID)
#define DEFAULT_CFE_PLATFORM_SB_HIGHEST_VALID_MSGID 0x1FFF
...
*/
#define CFE_PLATFORM_SB_DEFAULT_ROUTING_FILENAME         CFE_PLATFORM_SB_CFGVAL(DEFAULT_ROUTING_FILENAME)
#define DEFAULT_CFE_PLATFORM_SB_DEFAULT_ROUTING_FILENAME "/ram/cfe_sb_route.dat"
...
**       #OS_MAX_PATH_LEN value.
*/
#define CFE_PLATFORM_SB_DEFAULT_PIPE_FILENAME         CFE_PLATFORM_SB_CFGVAL(DEFAULT_PIPE_FILENAME)
#define DEFAULT_CFE_PLATFORM_SB_DEFAULT_PIPE_FILENAME "/ram/cfe_sb_pipe.dat"
...
**       #OS_MAX_PATH_LEN value.
*/
#define CFE_PLATFORM_SB_DEFAULT_MAP_FILENAME         CFE_PLATFORM_SB_CFGVAL(DEFAULT_MAP_FILENAME)
#define DEFAULT_CFE_PLATFORM_SB_DEFAULT_MAP_FILENAME "/ram/cfe_sb_msgmap.dat"
...
*/
#define CFE_PLATFORM_SB_FILTERED_EVENT1         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT1)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT1 CFE_SB_SEND_NO_SUBS_EID

#define CFE_PLATFORM_SB_FILTER_MASK1         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK1)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK1 CFE_EVS_FIRST_4_STOP

#define CFE_PLATFORM_SB_FILTERED_EVENT2         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT2)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT2 CFE_SB_DUP_SUBSCRIP_EID

#define CFE_PLATFORM_SB_FILTER_MASK2         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK2)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK2 CFE_EVS_FIRST_4_STOP

#define CFE_PLATFORM_SB_FILTERED_EVENT3         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT3)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT3 CFE_SB_MSGID_LIM_ERR_EID

#define CFE_PLATFORM_SB_FILTER_MASK3         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK3)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK3 CFE_EVS_FIRST_16_STOP

#define CFE_PLATFORM_SB_FILTERED_EVENT4         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT4)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT4 CFE_SB_Q_FULL_ERR_EID

#define CFE_PLATFORM_SB_FILTER_MASK4         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK4)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK4 CFE_EVS_FIRST_16_STOP

#define CFE_PLATFORM_SB_FILTERED_EVENT5         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT5)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT5 0

#define CFE_PLATFORM_SB_FILTER_MASK5         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK5)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK5 CFE_EVS_NO_FILTER

#define CFE_PLATFORM_SB_FILTERED_EVENT6         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT6)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT6 0

#define CFE_PLATFORM_SB_FILTER_MASK6         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK6)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK6 CFE_EVS_NO_FILTER

#define CFE_PLATFORM_SB_FILTERED_EVENT7         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT7)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT7 0

#define CFE_PLATFORM_SB_FILTER_MASK7         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK7)
#define DEFAULT_CFE_PLATFORM_SB_FILTER_MASK7 CFE_EVS_NO_FILTER

#define CFE_PLATFORM_SB_FILTERED_EVENT8         CFE_PLATFORM_SB_CFGVAL(FILTERED_EVENT8)
#define DEFAULT_CFE_PLATFORM_SB_FILTERED_EVENT8 0

#define CFE_PLATFORM_SB_FILTER_MASK8         CFE_PLATFORM_SB_CFGVAL(FILTER_MASK8)
...
*/
#define CFE_PLATFORM_SB_POOL_MAX_BUCKETS         CFE_PLATFORM_SB_CFGVAL(POOL_MAX_BUCKETS)
...
*/
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_01         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_01)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_01 8
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_02         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_02)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_02 16
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_03         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_03)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_03 20
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_04         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_04)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_04 36
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_05         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_05)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_05 64
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_06         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_06)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_06 96
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_07         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_07)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_07 128
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_08         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_08)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_08 160
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_09         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_09)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_09 256
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_10         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_10)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_10 512
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_11         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_11)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_11 1024
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_12         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_12)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_12 2048
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_13         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_13)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_13 4096
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_14         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_14)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_14 8192
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_15         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_15)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_15 16384
#define CFE_PLATFORM_SB_MEM_BLOCK_SIZE_16         CFE_PLATFORM_SB_CFGVAL(MEM_BLOCK_SIZE_16)
#define DEFAULT_CFE_PLATFORM_SB_MEM_BLOCK_SIZE_16 32768
#define CFE_PLATFORM_SB_MAX_BLOCK_SIZE            CFE_PLATFORM_SB_CFGVAL(MAX_BLOCK_SIZE)
...
**       Not Applicable
*/
#define CFE_PLATFORM_SB_START_TASK_PRIORITY         CFE_PLATFORM_SB_CFGVAL(START_TASK_PRIORITY)
#define DEFAULT_CFE_PLATFORM_SB_START_TASK_PRIORITY 9
